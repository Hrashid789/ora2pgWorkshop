...
- [Migrating Oracle to PostgreSQL hands-on lab step-by-step](#migratingoracletopostgresql-hands-on-lab-step-by-step)
  ...
  - [Exercise 1: Setup Oracle 11g Express Edition](#exercise-1-setup-oracle-11g-express-edition)
    - [Task 1: Setup ora2pg](#task-1-setup-ora2pg)
    - [Task 2: Setup Oracle](#task-2-setup-oracle)
  - [Exercise 2: Export Oracle schema and data to VM](#exercise-2-export-oracle-schema-and-data-to-VM)
  - [Exercise 3: Prepare to Migrate the Oracle database to PostgreSQL](#exercise-4-prepare-to-migrate-the-oracle-database-to-postgresql)
